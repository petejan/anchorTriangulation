 ...
 * 
 * This class does not delete the data like the jfree chart one does
 * 
 */
public class JDBCXYDatasetAdd extends AbstractXYDataset
     ...
     */
    public JDBCXYDatasetAdd(String url,
                         String driverName,
                         String user,
                         String password)
     ...
     * @throws SQLException if there is a problem connecting to the database.
     */
    public JDBCXYDatasetAdd(Connection con) throws SQLException {
        this();
        this.connection = con;
    }
     ...
     */
    public JDBCXYDatasetAdd(Connection con, String query) throws SQLException {
        this(con);
        executeQuery(query);
    }
